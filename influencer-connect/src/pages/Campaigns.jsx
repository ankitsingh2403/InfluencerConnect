...
export default function Campaigns() {
  ...
  const fetchCampaigns = async () => {
    try {
      const res = await axios.get(
        "https://influencerconnect1.onrender.com/api/campaigns"
      );
  ...
  const fetchInfluencers = async () => {
    try {
      const res = await axios.get(
        "https://influencerconnect1.onrender.com/api/influencers"
      );
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this campaign?")) {
      try {
        await axios.delete(
          `https://influencerconnect1.onrender.com/api/campaigns/${id}`
        );
        fetchCampaigns();
      } catch (err) {
  ...
  const testimonials = [
    {
      image:
        "https://cdn.dribbble.com/userupload/33247681/file/original-de62d39721a6d66beb38865efc10a186.gif",
      name: "Nike",
      tagline: "Just Do It",
    },
    {
      image:
        "https://i.pinimg.com/originals/be/cb/ca/becbca09cc81c9ecd1ce133c836b3f25.gif",
      name: "Apple",
      tagline: "Think Different",
    },
    {
      image:
        "https://cdn.dribbble.com/userupload/34378341/file/original-e9e9ae1ec33ec8eee369b1c353b5d4dc.gif",
      name: "Coca-Cola",
      tagline: "Taste the Feeling",
    },
    {
      image:
        "https://cdn.dribbble.com/userupload/32336676/file/original-2c8c2bad74bc2f35e1b078023fa74f30.gif",
      name: "Adidas",
      tagline: "Impossible is Nothing",
    },
    {
      image:
        "https://cdn.dribbble.com/userupload/40918746/file/original-b87776986e2024ab6bb7439e37c342c6.gif",
      name: "Samsung",
      tagline: "Inspire the World, Create the Future",
    },
    {
      image:
        "https://cdn.dribbble.com/userupload/23631797/file/original-7a2b31fe0a593a8525050464ab3b2d98.gif",
      name: "Microsoft",
      tagline: "Empower Every Person and Every Organization",
    },
    {
      image:
        "https://cdn.dribbble.com/userupload/23828810/file/original-e4b24bda6966fe3e908d1a1aaf0ba138.gif",
      name: "Amazon",
      tagline: "Work Hard, Have Fun, Make History",
    },
    {
      image:
        "https://media2.giphy.com/media/v1.Y2lkPTZjMDliOTUyNW1hZjQwajF2cnZmcXBuZHYzYTdyZGVvdHI0YzRwYzlocHFsdzhmNyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/5NPhdqmyRxn8I/source.gif",
      name: "Google",
      tagline: "Organize the World's Information",
    },
    {
      image:
        "https://cdn.dribbble.com/userupload/35193119/file/original-5b3017646682be495861ba95227c6985.gif",
      name: "Facebook",
      tagline: "Connect with Friends and the World Around You",
    },
    {
      image:
        "https://cdn.dribbble.com/userupload/42262899/file/original-aa38bfe6376d3f01f775f6ee71fe94c7.gif",
      name: "Twitter",
      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
        ...
        >
          ...
          <div className="md:col-span-2">
            <button
              type="submit"
              className="w-full p-3 bg-lime-500 hover:bg-lime-600 text-black font-bold rounded-xl transition-all"
            >
              Add Campaign
            </button>
          </div>
        ...
        {/* Campaigns List */}
        <h2 className="text-2xl mt-16 mb-6 font-semibold">
          ...
          {campaigns.map((camp) => (
            ...
            >
              ...
              >
                ...
                <p className="text-sm">
                  Duration: {camp.startDate?.slice(0, 10)} to{" "}
                  {camp.endDate?.slice(0, 10)}
                </p>
                <p className="text-sm mt-2">
                  Influencers Assigned: {camp.influencers?.length || 0}
                </p>
                ...
                <div className="flex justify-end items-center mt-4 text-lime-400">
                  ...
                  <FiEye
                    className="text-xl"
                    title="Click to view assigned influencers"
                  />
                </div>
              </div>
            </div>
        ...
        <h2 className="text-3xl font-bold mt-20 mb-8 text-center text-lime-400">
          ...
          {testimonials.map((brand, i) => (
            ...
            >
              <img
                src={brand.image}
                alt={brand.name}
                className="w-20 h-20 rounded-full mx-auto mb-4 object-cover border-2 border-lime-400"
              />
